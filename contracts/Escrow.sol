...
contract Escrow
{
    ...
    {
        require(amount <= token.allowance(address(this),msg.sender));
        ...
        token.transferFrom(msg.sender, address(this), step.amount);    //transfer to escrow
        token.transferFrom(msg.sender, feeAccount, fee); //withdraw fee
    }
